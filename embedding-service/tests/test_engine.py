...
class EmbeddingEngineTest(unittest.TestCase):
    ...
    def test_qwen_query_prepends_instruction_prompt_without_e5_prefix(self):
        model = FakeModel()
        engine = EmbeddingEngine(
            ...
            EmbeddingConfig(
                ...
                query_prompt="Instruct: Retrieve the geographic entity that best answers the query\nQuery:",
