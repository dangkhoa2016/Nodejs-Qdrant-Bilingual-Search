...
const preflightRaw = await collectBenchmarkPreflight({ apiUrl, embeddingUrlOverride: process.env.BENCHMARK_EMBEDDING_URL, expectedBackend: process.env.BENCHMARK_EMBEDDING_BACKEND ?? 'transformers', expectedImplementation: 'python-fastapi' })
